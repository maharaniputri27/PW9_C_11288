...
<head>
    ...
    <style>
        body{
            background: url('https://wallpapers.com/images/high/zigzag-river-aesthethic-landscape-zrf9jzxpxx736bd0.webp');
...
<body>
    <div class="container center-container">
        <div class="col-md-6 register-box">
            ...
            <form method="post" action="{{route('actionRegister')}}">
                ...
                <div class="form-group">
                    <label> <i class="fa fa-envelope"></i>Username</label>
    ...
    <script src="https://cdn.jsdelivr.net/npm/jquery@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html>