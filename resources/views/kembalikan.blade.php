    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('kembalikan')}}">Kembalikan</a>
                </li>
            </ul>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                     <div class="from-row">
                     <button type="button" class="btn btn-primary btn-lg" style="background-color: #00A86B; color: black; border: none;">Buku Dipinjam</button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        @forelse ($kembalikanBuku as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('kembalikan.update', ['id_buku' => $item->id_buku]) }}">
                                                    <button type="submit" class="btn btn-primary">Kembalikan</i>
                                                    </button>
                                                </form>
                                            </td>
                                        </tr>
